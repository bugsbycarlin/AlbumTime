...
class Game {
  ...
  preloadAnimations(and_then) {
    ...
    Assets.add({ alias: "living_room_floor_1", src: "Art/living_room_floor_1.png" });
    Assets.add({ alias: "living_room_floor_2", src: "Art/living_room_floor_2.png" });
    Assets.add({ alias: "living_room_floor_3", src: "Art/living_room_floor_3.png" });
    Assets.add({ alias: "living_room_floor_4", src: "Art/living_room_floor_4.png" });
    Assets.add({ alias: "living_room_floor_5", src: "Art/living_room_floor_5.png" });
    Assets.add({ alias: "living_room_floor_6", src: "Art/living_room_floor_6.png" });
